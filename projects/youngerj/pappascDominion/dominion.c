...
int playBaron (struct gameState *state, int choice) {
  int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      //Refactored code for this statement is above
    ...
    case smithy:
      //Everything that existed in this switch case is now in its own function
